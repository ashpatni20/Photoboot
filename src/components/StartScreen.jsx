  ...
  return (
    <div className="bg-[#121420] text-white text-center">
      <div className="w-[35%] m-auto pt-28">
        ...
        <button
          className="h-[50px] w-full rounded-[50px] bg-white text-black my-4"
        ...
        <button
          className="h-[50px] w-full rounded-[50px] bg-[#48CAE4] text-white my-4 mb-10"
        ...
        <button
          className="h-[50px] w-full rounded-[50px] bg-white text-black my-4 mb-28"
